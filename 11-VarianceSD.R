...
# Let’s find out how many standard deviations away from the mean NBA great Lebron James is. 
# To begin, let’s find the difference between Lebron’s height (80 inches) and the mean of each dataset.
